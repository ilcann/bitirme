...
const CourseOverviewPage = () => {
    ...
    const copy = useMemo(() => {
        if (isTurkish) {
            return {
                pageTitle: 'Ders Özeti',
                pageDescription: 'Dersin takvimini, ekibini ve haftalık akışını görüntüleyin.',
                summaryTitle: 'Dersin Özeti',
                summaryFallback: 'Bu ders için henüz bir özet eklenmemiş.',
                academicTitle: 'Akademik Takvim',
                academicDescription: 'Dönem ve erişim tarihleri.',
                teamTitle: 'Eğitim Ekibi',
                teamDescription: 'Dersi yürüten ekip bilgileri.',
                scheduleTitle: 'Haftalık Plan',
                ...
                noAssistants: 'Tanımlı yardımcı yok',
                noSchedule: 'Yer ve zaman bilgisi eklenmemiş',
                noTeam: 'Bu alan için bilgi eklenmemiş',
            };
        }
                ...
                <Card className="overflow-hidden rounded-3xl border-border/60 bg-linear-to-br from-card via-card to-muted/50 shadow-sm">
                    ...
                    <CardContent className="space-y-5 pt-6">
                        ...
                        <div className="rounded-2xl border border-border/60 bg-background/80 p-5">
                            <p className="text-sm leading-7 text-foreground/90 whitespace-pre-wrap">{localizedSummary || copy.summaryFallback}</p>
                        </div>
                    </CardContent>
                </Card>
